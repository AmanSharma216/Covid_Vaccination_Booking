...
<div style="margin-top: 50px">
      ...
      <h1 class="alert-danger">Choose Time & Date</div>
...
include "DBconnection.php";
   ...
   $query = "UPDATE second_vaccine_requests SET SvaccineTime='$SvaccineTime' WHERE patientID= $pid" ;
...
<input type="datetime-local"  name="SvaccineTime" id="SvaccineTime" >
<input type="submit" class="btn btn-danger btn-lg" value="Select this Time" name="submit"/>
</form>
