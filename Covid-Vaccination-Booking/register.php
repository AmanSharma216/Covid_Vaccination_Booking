                        ...
                        <form id="login-form" action="userinsert.php"  class="form" method="post">
                          ...
                          <h1  align="center">Register</h1>
							...
							<div class="form-group">
                                ...
                                <input type="text" name="password" id="password" class="form-control"  placeholder="Enter a Password" required>
                            </div>
							<div class="form-group">
							...
							<div class="form-group">
                                ...
                                <input type="text" name="nic" id="nic" class="form-control"  placeholder="Enter your Adhaar Number" required>
                            </div>
