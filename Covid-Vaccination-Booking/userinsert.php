...
if (!$uppercase || !$lowercase || !$number || !$specialchars || strlen($password) < 8) {
    echo'<script type="text/javascript">alert("Weak Password (Password should be atleast 8 letters long including a number,symbol,upper and lower case)");history.go(-1);</script>';
}
